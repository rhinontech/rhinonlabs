...
export const testimonials: Testimonial[] = [
    {
        text: "This service exceeded my expectations. The quality and speed were outstanding!",
        authorImg: "https://randomuser.me/api/portraits/women/1.jpg",
        authorName: "Sarah Thompson",
        authorPost: "Marketing Director"
    },
    {
        text: "Absolutely fantastic experience. The team understood my needs perfectly.",
        authorImg: "https://randomuser.me/api/portraits/men/2.jpg",
        authorName: "James Anderson",
        authorPost: "Product Manager"
    },
    {
        text: "I loved working with them — everything was smooth, fast, and professional.",
        authorImg: "https://randomuser.me/api/portraits/women/3.jpg",
        authorName: "Emily Carter",
        authorPost: "UX Designer"
    },
    {
        text: "Incredible value for money. I will definitely use this service again.",
        authorImg: "https://randomuser.me/api/portraits/men/4.jpg",
        authorName: "Michael Lee",
        authorPost: "Startup Founder"
    },
    {
        text: "Amazing results. The attention to detail really made a difference.",
        authorImg: "https://randomuser.me/api/portraits/women/5.jpg",
        authorName: "Olivia Martinez",
        authorPost: "Creative Lead"
    }
];
const Testimonials = () => {
    return (
                            ...
                            <div className="bg-card w-full h-full p-7 flex flex-col justify-between">
                                ...
                                <div className="flex">
                                    ...
                                    <div className="pl-5 flex items-center">
                                        <img src="https://framerusercontent.com/images/igKvrrUwUNpWCRQ7HMZUis6Jw.png" height={20} width={20} alt="" />
                                    </div>
                                </div>
